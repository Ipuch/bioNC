...
class NaturalSegment(AbstractNaturalSegment):
    ...
    rigid_body_constraint_acceleration_bias()
        This function returns the acceleration bias vector for the rigid body constraints
    ...
    def compute_transformation_matrix_inverse(self, matrix_type: str | TransformationMatrixType = None) -> np.ndarray:
        ...
        ----------
        matrix_type : str or TransformationMatrixType
            The type of the transformation matrix to invert, either "Buv" or TransformationMatrixType.Buv
    ...
    def add_natural_vector_from_segment_coordinates(
        ...
        direction = self.compute_transformation_matrix_inverse(transformation_matrix_type) @ direction
    ...
    def add_natural_marker_from_segment_coordinates(
        ...
        location = self.compute_transformation_matrix_inverse(transformation_matrix_type) @ location
