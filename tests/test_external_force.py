...
def test_external_force(bionc_type):
    ...
    TestUtils.assert_equal(pseudo_interpolation_matrix, np.array([[ 0.        ,  0.14285714,  0.        ,  0.17142857,  0.17142857,
         1.02857143, -0.17142857, -0.17142857, -1.02857143,  0.        ,
         0.        ,  0.        ],
       [ 0.        ,  0.14285714,  0.        ,  0.02857143,  0.02857143,
         0.17142857, -0.02857143, -0.02857143, -0.17142857,  0.85714286,
         0.14285714,  0.14285714],
       [ 0.        ,  0.85714286,  0.        ,  0.02857143,  0.02857143,
         0.17142857, -0.02857143, -0.02857143, -0.17142857,  0.        ,
         0.        ,  0.        ]]))

    TestUtils.assert_equal(
        natural_force,
        np.array([ 0.0187    ,  0.19897143,  0.0221    ,  0.16265714,  0.17445714,
        0.35054286, -0.05265714, -0.05445714, -0.22054286,  0.14947143,
        0.04422857,  0.04612857]),
    )
